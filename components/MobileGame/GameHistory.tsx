        ...
        <CardContent>
          {pastRounds.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="text-gray-400">No completed rounds yet. Be the first to play!</p>
            </div>
          ) : (
                        ...
                        <div className="space-y-2">
                          <div className="flex items-center gap-2 flex-wrap">
                            <Badge 
                              ...
                              className={`text-white border ${round.result === "heads" ? "border-orange-400 bg-orange-500/20" : "border-cyan-400 bg-cyan-500/20"}`}
                            >
                            ...
                            {playerInRound && (
                              <Badge 
                                ...
                                className={playerWon ? "border-green-400 bg-green-500/20 text-green-300" : "border-red-400 text-red-300"}
                              >
                                {playerWon ? "Won" : "Lost"}
                              </Badge>
                            )}
                          ...
                          <div className="flex items-center gap-4 text-sm text-gray-300 flex-wrap">
                            ...
                            <div className="flex items-center gap-1">
                              ...
                              <span className="text-white">${round.pot} pot</span>
                            </div>
                            <div className="flex items-center gap-1">
